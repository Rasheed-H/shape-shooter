...
function addStartGameButton(){
        ...
        startButton.setAttribute("stroke", "blue")
        startButton.setAttribute("fill", "dodgerblue")
...
function startTimer(seconds) {
        ...
        liveTimer.setAttribute("stroke", "white")
        liveTimer.setAttribute("font-family", "Arial, Helvetica, sans-serif")
...
function addTarget(){
    ...
    if(mode ==  1){
        ...
        tapTarget.setAttribute("fill", "dodgerblue")
        ...
        trackTarget.setAttribute("fill", "dodgerblue")
...
function updateScoreBoard(){
    ...
    if(mode == 1){
        ...
        liveCounter.setAttribute("stroke", "gold")
        liveCounter.setAttribute("font-family", "Arial, Helvetica, sans-serif")
    ...
    if(mode == 2){
        ...
        trackerLiveCounter.setAttribute("stroke", "gold")
        trackerLiveCounter.setAttribute("font-family", "Arial, Helvetica, sans-serif")
